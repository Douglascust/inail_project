...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative text-center mb-5">CADASTRO</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="contact-form bg-light rounded p-5">
                        <div id="success"></div>
                        <form name="sentMessage" id="cadastroForm" novalidate="novalidate">
                            <div class="form-row">
                                <div class="col-sm-6 control-group">
                                    <input type="text" class="form-control p-4" name="nome" placeholder="Seu Nome" required="required" data-validation-required-message="Please enter your name" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="col-sm-6 control-group">
                                    <input type="text" class="form-control p-4" id="cpf" name="cpf" placeholder="Seu CPF" required="required" data-validation-required-message="Please enter your cpf" />
                                    <p class="help-block text-danger"></p>
                                    <div name="msgCpf"></div>
                                </div>
                            </div>
                            <div class="control-group">
                                <input type="email" class="form-control p-4" id="email" name="email" placeholder="Seu Email" required="required" data-validation-required-message="Please enter your email" />
                                <p class="help-block text-danger"></p>
                                <div name="msgEmail"></div>
                            </div>
                            <div class="control-group">
                                <input type="password" class="form-control p-4" name="senha" placeholder="Crie uma senha" required="required" data-validation-required-message="Please enter your password" />
                                <p class="help-block text-danger"></p>
                            </div>
                    </div>
                            <div id="insertBtn">
                                <button class="btn btn-primary btn-block py-3 px-5" type="submit">Cadastrar</button>
                            </div>
                        </form>
                    </div>
                </div>
  ...
  <!-- rodape -->
    ...
    <script src="public/assets/js/caduser.js"></script>
