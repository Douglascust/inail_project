...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative text-center mb-5">ACESSO MANICURE</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="contact-form bg-light rounded p-5">
                        <div id="success"></div>
                        <form name="sentMessage" action="cliente" id="loginmaniForm" novalidate="novalidate">
                            <div class="form-row">
  ...
  <!-- rodape -->
    <div class="container-fluid footer bg-light py-5" style="margin-top: 90px;">
        ...
        <script src="public/assets/js/loginmani.js"></script>
    </body>
</html>